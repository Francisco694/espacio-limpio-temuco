...
export const ejecutarCargaMasiva = async () => {
    ...
    try {
        ...
        alert(`¡Carga masiva completada! ${registrosCreados} registros creados. Por favor, BORRA EL SCRIPT AHORA.`);
...
// ============================================================================
// PARA EJECUTAR: 
// 1. Descomenta la línea de abajo.
// 2. Recarga tu panel de control (Dashboard).
// 3. Vuelve a comentar la línea INMEDIATAMENTE para evitar duplicados.
// ============================================================================
