 ...
 * Dashboard 100% Funcional (Seguridad Auth + CRUD Firestore)
 */
...
function suscribirACotizaciones() {
    ...
    _unsubscribe = onSnapshot(q,
        ...
        (error) => {
            ...
            alert("No tienes permisos o falló la conexión a Firebase.");
        }
    );
}
...
window.cambiarEstado = async (idDocumento, nuevoEstado) => {
    try {
        ...
        // No es necesario recargar la tabla manualmente, onSnapshot lo hará por nosotros
    } catch (error) {
